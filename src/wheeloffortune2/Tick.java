...
public class Tick extends JPanel {
    ...
    private Polygon getTriangle() {
        ...
        int baseY = 0; // flat base at the top
        int tipY = this.getHeight(); // tip at the bottom
        int baseOffsetX = (int) (this.getHeight() * Math.tan(Math.toRadians(30)));

        polygon.addPoint(centerX, tipY);                // tip pointing down
        polygon.addPoint(centerX - baseOffsetX, baseY); // left corner
        polygon.addPoint(centerX + baseOffsetX, baseY); // right corner
